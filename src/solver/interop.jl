...
const SOLVER_SHARED_BUFFER_CACHE_LOCK = getproperty(GeoDynamo, :__BUFFER_CACHE_LOCK)
...
const SOLVER_GPU_NOT_LOADED_ERROR = getproperty(GeoDynamo, :__gpu_backend_not_loaded_error)
const SOLVER_GPU_UNAVAILABLE_ERROR = getproperty(GeoDynamo, :__gpu_backend_unavailable_error)
