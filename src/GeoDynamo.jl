module GeoDynamo
    ...
    export SolverBackend, SolverFields, SolverTopographyState, SolverTimestepState, SolverGradientWorkspace, TransformWorkspace, SolverRuntime, SolverState
    ...
    using .bcs: BoundaryType, DIRICHLET, NEUMANN, MIXED, ROBIN, NEUMANN_DERIV1, NEUMANN_DERIV2, NEUMANN_MAG_INNER, NEUMANN_MAG_OUTER, CONTINUITY_MAG
