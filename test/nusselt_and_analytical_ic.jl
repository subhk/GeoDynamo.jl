...
@testset "Nusselt and analytical IC normalization" begin
    ...
    @testset "Random/hot_blob (0,0) background means reconstruct physically" begin
        ...
        G.generate_random_initial_conditions!(
            tr, :temperature, amplitude = 0.2, modes_range = 1:3, seed = 7)
        ...
        G.set_analytical_initial_conditions!(th, :temperature, :hot_blob, amplitude = amp,
