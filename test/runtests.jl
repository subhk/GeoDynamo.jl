...
additional_tests = (
    ...
    "timestep_state.jl",
    "cb3_timestepper.jl",
    "cb3_diffusion_consistency.jl",
    "scalar_neumann_l0_consistency.jl",
    "examples_audit.jl",
    "examples_smoke.jl",
    # Validation
    ...
    "topo_integration_coverage.jl",
    "user_api.jl",
    "oceananigans_api.jl",
    "api_codex_fixes.jl",
    "codex_validation_fixes.jl",
    "code_review_max_fixes.jl",
    ...
    "energy_diagnostics_volume_weight.jl",
    "parseval_m_factor.jl",
    "topography_bc_injection.jl",
    "nonlinear_reuse_physical.jl",
    "proc_grid_balance.jl",
    ...
    "inner_core_spectral_pencil_decomp.jl",
    "rank_seed_decorrelation.jl",
