...
!------------------------------------------------------------------------
   subroutine mag_matrices()
      ...
      do l = 1, i_L1
         call tim_iclumesh_X    ( 1d0, 1d0/d_Pm, l, XTor(l) )
         call mag_bc_Tor        ( XTor(l), l)
         call mes_iclu_find     ( XTor(l) )
         call tim_mesh_Y        ( mes_oc, 1d0, 1d0/d_Pm, l,   YTor(l) )
         call tim_mesh_Y        ( mes_ic, 1d0, 1d0/d_Pm, l, icYTor(l) )
      end do

      do l = 1, i_L1
         call tim_iclumesh_X    ( 1d0, 1d0/d_Pm, l, XPol(l) )
         call mag_bc_Pol        ( XPol(l), l)
         call mes_iclu_find     ( XPol(l) )
         call tim_mesh_Y        ( mes_oc, 1d0, 1d0/d_Pm, l,   YPol(l) )
         call tim_mesh_Y        ( mes_ic, 1d0, 1d0/d_Pm, l, icYPol(l) )
      end do
