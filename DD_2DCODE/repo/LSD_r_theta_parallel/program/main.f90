...
!-------------------------------------------------------------------------
   subroutine initialise()
      ...
      if(mpi_rnk==0)  print*,    'loading codBC...'
      call io_load_codBC()
